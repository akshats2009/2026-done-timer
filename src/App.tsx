...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
        ...
        <GlassPanel intensity="subtle" className="rounded-lg">
          <div className="mx-auto flex h-12 max-w-6xl items-center justify-between px-4 sm:px-6">
            <div className="flex items-center gap-2.5">
              <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-foreground/10">
      ...
      {/* Hero - takes up the entire page */}
      <section className="relative flex min-h-screen w-full flex-col items-center justify-center">
        <div className="flex w-full flex-col items-center justify-center px-4 sm:px-8 lg:px-16 text-center">
        ...
        {/* Scroll down arrow - fixed bottom right corner */}
        <button
          onClick={scrollToContent}
          className="fixed bottom-8 right-8 z-40 flex h-10 w-10 items-center justify-center rounded-lg bg-background/80 text-foreground/60 hover:text-foreground border border-border/40 cursor-pointer backdrop-blur-sm"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <GlassPanel intensity="medium" className="rounded-lg p-6">
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-lg bg-foreground/10">
